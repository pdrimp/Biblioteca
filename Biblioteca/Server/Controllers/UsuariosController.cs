...
namespace Biblioteca.Server.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuario>> GetUsuario(int id)
        {
            ...
            var usuario = await _context.Usuarios.Include(p => p.Prestamos).ThenInclude(l=>l.Libro).FirstOrDefaultAsync(r => r.Id == id);
        ...
        public async Task<ActionResult<Usuario>> PostUsuario(Usuario usuario)
        {
            if (_context.Usuarios == null)
            {
                return Problem("Entity set 'BDBibliotecaContext.Usuarios'  is null.");
            }
