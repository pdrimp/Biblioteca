...
namespace Biblioteca.Server.Migrations
{
    ...
    [Migration("20230523161106_con_prestamos")]
    partial class con_prestamos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biblioteca.Shared.Modelos.Prestamo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Biblioteca.Shared.Modelos.Prestamo", b =>
                {
                    b.HasOne("Biblioteca.Shared.Modelos.Libro", "Libro")
                        .WithMany("Prestamos")
                        .HasForeignKey("LibroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Biblioteca.Shared.Modelos.Usuario", "Usuario")
                        .WithMany("Prestamos")
